...
| RMSE additional penalty       | [4.49001376] |

| RMSE (per dataset)   |   weighted |   unweighted |
|----------------------|------------|--------------|
| 1.dataset1:          |   3.00e+01 |     3.00e+01 |
| 2.dataset2:          |   2.97e-04 |     2.97e-04 |
...
* **km1**:
  * *Label*: km1
  * *Matrix*: 
    * *('s1', 's4')*: rates.k1: **2.52735e-01** *(StdErr: 3e-01 ,initial: 2.10000e-01)*
    * *('s3', 's1')*: rates.k2: **1.56406e-01** *(StdErr: 4e-01 ,initial: 1.95500e-01)*
    * *('s2', 's1')*: rates.k3: **8.70000e-02** *(fixed)*
    * *('s5', 's2')*: rates.k4: **2.47014e-01** *(StdErr: 7e-01 ,initial: 2.67000e-01)*
    * *('s6', 's3')*: rates.k5: **1.12632e-02** *(StdErr: 4e-02 ,initial: 6.40000e-03)*
    * *('s6', 's6')*: rates.k6: **1.62958e-06** *(StdErr: 5e-07 ,initial: 1.30000e-06)*
    * *('s5', 's5')*: rates.k6: **1.62958e-06** *(StdErr: 5e-07 ,initial: 1.30000e-06)*
...
* **dataset2**:
  ...
  * *Scale*: scale.2: **8.61959e-01** *(StdErr: 3e+00 ,initial: 8.62000e-01)*
