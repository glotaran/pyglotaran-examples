| Optimization Result           |                                 |
|-------------------------------|---------------------------------|
| Number of residual evaluation | 109                             |
...
| RMSE additional penalty       | [5.02184247e-05 9.48431564e-05] |

| RMSE (per dataset)   |   weighted |   unweighted |
|----------------------|------------|--------------|
| 1.dataset1:          |   8.48e-05 |     8.48e-05 |
| 2.dataset2:          |   6.43e-05 |     6.43e-05 |
| 3.dataset3:          |   1.07e-04 |     1.07e-04 |
| 4.dataset4:          |   3.80e-05 |     3.80e-05 |
| 5.dataset5:          |   1.57e-04 |     1.57e-04 |
| 6.dataset6:          |   1.90e-05 |     1.90e-05 |
...
* **input1**:
  ...
  * *Parameters*: [inputs.1: **5.00000e-01** *(fixed)*, inputs.2: **3.05578e-01** *(StdErr: 7e-03 ,initial: 5.10000e-02)*, inputs.3: **1.81049e-01** *(StdErr: 3e-03 ,initial: 2.52000e-01)*]
  * *Exclude From Normalize*: []
* **input2**:
  * *Label*: input2
  * *Compartments*: ['s1', 's2', 's3']
  * *Parameters*: [inputs.1: **5.00000e-01** *(fixed)*, inputs.7: **3.97441e-01** *(StdErr: 7e-03 ,initial: 5.21000e-02)*, inputs.8: **3.89975e-01** *(StdErr: 3e-03 ,initial: 2.20000e-01)*]
  * *Exclude From Normalize*: []
* **input3**:
  * *Label*: input3
  * *Compartments*: ['s1', 's2', 's3']
  * *Parameters*: [inputs.1: **5.00000e-01** *(fixed)*, inputs.9: **3.55235e-01** *(StdErr: 7e-03 ,initial: 5.22000e-02)*, inputs.10: **2.89950e-01** *(StdErr: 3e-03 ,initial: 2.20000e-01)*]
  * *Exclude From Normalize*: []
...
* **dataset3**:
  * *Label*: dataset3
  * *Megacomplex*: ['complex1']
  * *Scale*: scale.2: **1.30684e+00** *(StdErr: 4e-04 ,initial: 1.30000e+00)*
...
* **dataset5**:
  * *Label*: dataset5
  * *Megacomplex*: ['complex1']
  * *Scale*: scale.3: **1.16421e+00** *(StdErr: 2e-04 ,initial: 1.10000e+00)*
