...
import glotaran
from pyglotaran_examples.io import load_data

from .plot_spectra import (plot_das, plot_norm_das, plot_norm_sas, plot_sas,
                           plot_spectra)
from .style import PlotStyle
from .plot_svd import (plot_lsv_data, plot_lsv_residual, plot_rsv_data,
                       plot_rsv_residual, plot_sv_data, plot_sv_residual,
                       plot_svd)
...
def plot_overview(result, center_λ=None):
    ...
    if 'center_dispersion_1' in res:
        ...
        irf_loc = center_dispersion.sel(
            spectral=center_λ, method='nearest').item()
    else:
