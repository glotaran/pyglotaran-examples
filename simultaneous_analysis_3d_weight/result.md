...
| RMSE additional penalty       | [1.03585398e-05 4.29740630e-06] |
...
* **input1**:
  ...
  * *Parameters*: [inputs.1: **5.00000e-01** *(fixed)*, inputs.2: **2.42151e-01** *(StdErr: 2e-03 ,initial: 2.42290e-01)*, inputs.3: **3.63162e-01** *(StdErr: 1e-03 ,initial: 3.63180e-01)*]
  * *Exclude From Normalize*: []
* **input2**:
  * *Label*: input2
  * *Compartments*: ['s1', 's2', 's3']
  * *Parameters*: [inputs.1: **5.00000e-01** *(fixed)*, inputs.7: **1.61306e-01** *(StdErr: 2e-03 ,initial: 1.61370e-01)*, inputs.8: **3.11549e-01** *(StdErr: 1e-03 ,initial: 3.11570e-01)*]
  * *Exclude From Normalize*: []
* **input3**:
  * *Label*: input3
  * *Compartments*: ['s1', 's2', 's3']
  * *Parameters*: [inputs.1: **5.00000e-01** *(fixed)*, inputs.9: **9.62565e-02** *(StdErr: 6e-03 ,initial: 9.61700e-02)*, inputs.10: **2.07943e-01** *(StdErr: 3e-03 ,initial: 2.08060e-01)*]
  * *Exclude From Normalize*: []
...
* **dataset2**:
  * *Label*: dataset2
  * *Megacomplex*: ['complex1']
  * *Scale*: scale.2: **8.80050e-01** *(StdErr: 3e-04 ,initial: 8.80052e-01)*
  * *Initial Concentration*: input2
  * *Irf*: irf2_no_dispersion
* **dataset3**:
  * *Label*: dataset3
  * *Megacomplex*: ['complex1']
  * *Scale*: scale.3: **7.27362e+01** *(StdErr: 6e-04 ,initial: 7.27300e+01)*
